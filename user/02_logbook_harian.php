            	...
            	echo"
              	<tr>
...

					{
						...
						<a href='02_delete_logbook_harian.php?id_logbook=$a[id_logbook]&tanggal_awal=$_POST[tanggal_awal]' onclick='return confirm(\"Anda yakin akan menghapus $a[uraian_pekerjaan] ?\")'class='btn btn-danger btn-xs'>
              ...
              <tr>
                ...
                <td>";
...

					{
						...
						<a href='02_delete_logbook_harian.php?id_logbook=$a[id_logbook]&tanggal_awal=$_GET[tanggal_awal]' onclick='return confirm(\"Anda yakin akan menghapus $a[uraian_pekerjaan] ?\")' class='btn btn-danger btn-xs'>
						<span class='glyphicon glyphicon-remove' aria-hidden='true'></span>
						</a>";
					}
					 elseif($a['status'] == 'Dinilai')
