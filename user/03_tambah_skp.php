    ...
    <div class="container-fluid" style="margin:30px;">	
		...
		<table width="100%" class="table table-bordered">
			...
			<form method="post" action="" enctype="multipart/form-data">
				...
				<td colspan="3"><input type="text" id="tglbln" name="bulan" required="yes" class="form-control" value="<?php echo $_GET['tanggal']; ?>"></td>
...
<form method="post" action="" enctype="multipart/form-data">
			...
			<tr>
				...
				<td colspan="4"><input type="number" placeholder="Mutu = 1-100" name="mutu" required="yes"  value="100" class="form-control"></td>
