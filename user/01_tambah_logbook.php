    ...
    <div class="container-fluid" style="margin:30px;">	
		<table width="100%" class="table table-bordered">
			...
			<tr>
				...
				<td><input type="text" name="jumlah_kegiatan_skp" class="form-control" value="0" required></td>
			...
			<tr>
				...
				<td><input type="text" name="jumlah_kegiatan" class="form-control" value="1" required></td>
