		...
		<a href="07_export_to_excel_pegawai.php" class="btn btn-success">Export to Excel</a>
			...
			<div class="box-body table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                    <thead>		
		  					<tr class="info">
								<th width="5%">No.</th><th>NIP</th><th>Nama Pegawai</th><th>Level</th><th>Password</th><th width="10%">Aksi</th>
							</tr>
					</thead>
			<?php 
							...
							<tr>
								...
								<td>
									<a href='07_edit_pegawai.php?id_pegawai=$a[id_pegawai]'>
										<button class='btn btn-danger btn-xs'>	<span class='glyphicon glyphicon-pencil' aria-hidden='true' >
										</span></button>
									</a> 
								</td>
							</tr>";
