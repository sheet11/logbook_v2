	        ...
	        <table width="100%" class= "table table-bordered" style="width:50%;">    
				   ...
				   if(isset($_POST['submit']))
				   {
					   ...
					   echo "<table border='0' width='100%'>   
                      	<tr>
	                        ...
	                        <td>:</td>
	                        <td>$a[bulan]</td>
							<td><a href='03_tambah_skp.php' target='_blank'><input type=button value='Tambah SKP' class='btn btn-warning'></a> &nbsp;
							<a href='03_cetak_target.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Cetak Target' class='btn btn-primary'></a> &nbsp;
							<a href='03_lihat_realisasi.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Lihat Realisasi' class='btn btn-info'></a> &nbsp;
							<a href='03_cetak_realisasi.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Cetak Realisasi' class='btn btn-success'></a></td>
                      	</tr>   
				...
				<tr>
					...
					<td>
						...
						<a href='03_delete_detail_skp.php?id_detail_skp=$kueri[id_detail_skp]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' onclick='return confirm(\"Anda yakin akan menghapus Uraian Pekerjaan $qry[uraian_skp] ?\")' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a>
				...
				<tr>
					...
					<td>
						...
						<a href='03_delete_detail_skp.php?id_detail_skp=$kueri[id_detail_skp]&bulan=$_GET[bulan]&tahun=$_GET[tahun]' onclick='return confirm(\"Anda yakin akan menghapus Uraian Pekerjaan $qry[uraian_skp] ?\")' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a>
					</td>
