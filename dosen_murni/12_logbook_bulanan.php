    ...
    <div id="page-wrapper" >
      ...
      <div>
        ...
        ";
          ...
          {
            echo "
            <a href='12_edit_logbook_bulanan.php?id_logbook=$a[id_logbook]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' class='btn btn-danger'>
    ...
    $tjam4 = $menit4 + $jam4;
	  ...
	  elseif(!empty($_GET['bulan']))
	  {
        ...
        ";
          ...
          {
            echo "
            <a href='12_edit_logbook_bulanan.php?id_logbook=$a[id_logbook]&bulan=$_GET[bulan]&tahun=$_GET[tahun]' class='btn btn-danger'>
            <span class='glyphicon glyphicon-pencil' aria-hidden='true'></span>
            </a>
