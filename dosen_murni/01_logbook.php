    ...
    <h5>Di Halaman Logbook Harian</h5>
    	<div style="margin:20px;">	
			...
			include "../config/koneksi.php";
					...
					$query=mysql_query("select * from tb_logbook as l, tb_detail_skp as de where l.id_detail_skp=de.id_detail_skp AND l.nip='$_SESSION[nip]' order by l.tanggal_logbook desc ");
