...
<body>
    ...
    <div>
        <form method="post" action="" enctype="multipart/form-data">    
          	<table class= "table table-bordered" >    
                ...
                $query = mysql_query("SELECT * FROM tb_logbook, tb_detail_skp WHERE nip='$_SESSION[nip]' AND tanggal_logbook = '$_POST[tanggal_awal]' AND tb_logbook.id_detail_skp=tb_detail_skp.id_detail_skp");
            	...
            	echo"
              	<tr>
					...
					{
						echo "
						<a href='02_edit_logbook_harian.php?id_logbook=$a[id_logbook]&tanggal_awal=$_POST[tanggal_awal]' class='btn btn-danger btn-xs'>
						<span class='glyphicon glyphicon-pencil' aria-hidden='true'></span></a>

						<a href='02_delete_logbook_harian.php?id_logbook=$a[id_logbook]&tanggal_awal=$_POST[tanggal_awal]' onclick='return confirm(\"Anda yakin akan menghapus $a[uraian_skp] ?\")'class='btn btn-danger btn-xs'>
			        ...
			        elseif($a['status'] == 'Dikembalikan')
			            ...
			            echo "<a href='02_edit_logbook_harian.php?id_logbook=$a[id_logbook]'>
			                  ...
			                  <a href='02_delete_logbook_harian.php?id_logbook=$a[id_logbook]' onclick='return confirm(\"Anda yakin akan menghapus $a[uraian_skp] ?\")'>
			                  <button type='button' class='btn btn-warning btn-circle'><i class='glyphicon glyphicon-remove'></i></button></a>";
			            }
    ...
    $npir = number_format($pir, 0, '', '.');
...

	  {
                  ...
                  $query = mysql_query("SELECT * FROM tb_logbook, tb_detail_skp WHERE nip='$_SESSION[nip]' AND tanggal_logbook = '$_GET[tanggal_awal]' AND tb_logbook.id_detail_skp=tb_detail_skp.id_detail_skp");
              ...
              <tr>
                ...
                <td>";
...

					{
						...
						echo "
						<a href='02_edit_logbook_harian.php?id_logbook=$a[id_logbook]&tanggal_awal=$_GET[tanggal_awal]' class='btn btn-danger btn-xs'>
						<span class='glyphicon glyphicon-pencil' aria-hidden='true'></span>
						</a>
						<a href='02_delete_logbook_harian.php?id_logbook=$a[id_logbook]&tanggal_awal=$_GET[tanggal_awal]' onclick='return confirm(\"Anda yakin akan menghapus $a[uraian_skp] ?\")' class='btn btn-danger btn-xs'>
						<span class='glyphicon glyphicon-remove' aria-hidden='true'></span>
						</a>";
					}
					 elseif($a['status'] == 'Dinilai')
