...
<?php
	...
	$query=mysql_query("select * from tb_logbook_dosen, tb_daftar_skp_dosen, tb_detail_skp_dosen where id_logbook='$_GET[id_logbook]' AND tb_logbook_dosen.id_daftar_skp=tb_daftar_skp_dosen.id_daftar_skp AND tb_logbook_dosen.id_detail_skp=tb_detail_skp_dosen.id_detail_skp");
    ...
    <div class="container-fluid" style="margin:30px;">	
		...
		<form method="post" action="12_prosesedit_logbook_bulanan.php" enctype="multipart/form-data">
			...
			<tr>
				...
				<td><input type="text" name="jumlah_kegiatan_skp" value="<?php echo "$a[jumlah_kegiatan_skp]"; ?>" class="form-control"></td>

				<td>Output Kegiatan SKP</td>

				<td><select name="output_kegiatan_skp" type="select" class="form-control">

					<option value="<?php echo "$a[output_kegiatan_skp]"; ?>"><?php echo "$a[output_kegiatan_skp]"; ?></option>
...
if(isset($_POST['proses'])){
					echo"<script>alert('Proses Tanggal Berhasil');window.location='12_edit_logbook_bulanan.php?id_logbook=$_POST[id_logbook]&bulan=$_POST[bulan]&tahun=$_POST[tahun]&tanggal=$_POST[tanggal]'</script>"; 
					}
?>