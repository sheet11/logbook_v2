...
<?php
	...
	if($query) { 
			echo "<script>alert('Data Berhasil di Update');window.location='12_logbook_bulanan.php?bulan=$bulan&tahun=$tahun'</script>";
	} else {
		echo "<script>alert('Data Gagal di Update');window.location=''12_logbook_bulanan.php?bulan=$bulan&tahun=$tahun'</script>";
	}
?>	
