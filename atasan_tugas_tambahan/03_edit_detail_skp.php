...
<?php
	...
	$query=mysql_query("select * from tb_detail_skp where id_detail_skp='$_GET[id_detail_skp]'");
	$a=mysql_fetch_array($query);
?>

<div id="page-wrapper">
    <div class="container-fluid" style="margin:30px;">
		<form method="post" action="03_prosesedit_detail_skp.php" enctype="multipart/form-data">	
