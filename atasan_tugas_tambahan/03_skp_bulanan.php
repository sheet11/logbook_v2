				   ...
				   if(isset($_POST['submit']))
				   {
					   ...
					   echo "<table border='0' width='100%'>   
                      	<tr>
							...
							<a href='03_cetak_target.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Cetak Target' class='btn btn-danger'></a>&nbsp;
							</td>
                      	</tr>   
				...
				<tr>
...

					{
						...
						<td>
							...
							<a href='03_delete_skp.php?id_daftar_skp=$qry[id_daftar_skp]&bulan=$_GET[bulan]&tahun=$_GET[tahun]' onclick='return confirm(\"Anda yakin akan menghapus $qry[nama_skp] ?\")' class='btn btn-danger btn-xs'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></a>
