...
<?php
	...
	$query = mysql_query("SELECT * FROM tb_logbook WHERE tanggal_logbook = '$_GET[tanggal]' AND nip='$_SESSION[nip]'");
...
<div>
	...
	<table class="table table-bordered">
		...
		<tr>
		 ...
		 $i++;}
		 $qr = mysql_query("SELECT SEC_TO_TIME( SUM( TIME_TO_SEC( `jumlah_menit` ) ) ) AS timeSum FROM tb_logbook WHERE tanggal_logbook='$_GET[tanggal]' AND nip='$_SESSION[nip]'");
	  ...
	  $juang = number_format($tuang, 0, '', '.');
          echo "<table class='table table-bordered'>
            		...
            		<tr>
            			<td>Total Uang sebelum dikurangi ketidakhadiran</td><td> :</td><td> $juang </td>
            		</tr>

                    <tr>
                        <td>Total Pengurangan Ketidakhadiran</td><td> :</td><td> $juang </td>
                    </tr>

                   <tr>
                        <td><b>Total Uang (Total Uang diterima - Ketidakhadiran) </b></td><td><b> :</b></td><td><b>  $juang <b></td>
                    </tr> 
                </table>";
		 ?>
