        ...
        <form method="post" action="" enctype="multipart/form-data">    
          	<table class= "table table-bordered">    
            	<tr>
                  ...
                  $query = mysql_query("SELECT * FROM tb_logbook_dosen, tb_detail_skp_dosen WHERE month(tanggal_logbook) = '$_POST[bulan]' AND year(tanggal_logbook) = '$_POST[tahun]' AND nip='$_POST[pegawai]' AND tb_logbook_dosen.id_detail_skp=tb_detail_skp_dosen.id_detail_skp");
            ...
            echo"
              <tr>
                ...
                <td>";
                      ...
                      {
                        echo "
                        	<a href='11_proses_validasi_logbook.php?logbook=$a[id_logbook]&pegawai=$a[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]'>
                        	<button type='button' class='btn btn-info btn-circle'><i class='glyphicon glyphicon-ok'></i></button></a>
                        	<a href='11_edit_validasi_logbook.php?id_logbook=$a[id_logbook]&pegawai=$a[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]'>
                      ...
                      {
                        echo "<a href='11_edit_validasi_logbook.php?id_logbook=$a[id_logbook]&pegawai=$a[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]'>
  ...
  $qr4 = mysql_query("SELECT SEC_TO_TIME( SUM( TIME_TO_SEC( `jumlah_menit` ) ) ) AS timeSum FROM tb_logbook_dosen WHERE nip='$_GET[pegawai]' AND month(tanggal_logbook) = '$_POST[bulan]' AND year(tanggal_logbook) = '$_POST[tahun]' AND status='Dikembalikan'");
    ...
    $tjam4 = $menit4 + $jam4;
      ...
      elseif(!empty($_GET['bulan'])){
                  $query = mysql_query("SELECT * FROM tb_logbook_dosen, tb_detail_skp_dosen WHERE month(tanggal_logbook) = '$_GET[bulan]' AND year(tanggal_logbook) = '$_GET[tahun]' AND nip='$_GET[pegawai]' AND tb_logbook_dosen.id_detail_skp=tb_detail_skp_dosen.id_detail_skp");
                  $jumlah = mysql_num_rows($query);
          if($query){
                  echo"
                  <p>&nbsp;</p>
            ...
            echo"
              <tr>
                ...
                <td>";
                      ...
                      {
                        echo "
                        <a href='11_proses_validasi_logbook.php?logbook=$a[id_logbook]&pegawai=$a[nip]&bulan=$_GET[bulan]&tahun=$_GET[tahun]'>
                        <button type='button' class='btn btn-info btn-circle'><i class='glyphicon glyphicon-ok'></i></button></a>
                        <a href='11_edit_validasi_logbook.php?id_logbook=$a[id_logbook]&pegawai=$a[nip]&bulan=$_GET[bulan]&tahun=$_GET[tahun]'>
                        <button type='button' class='btn btn-info btn-circle'><i class='glyphicon glyphicon-envelope'></i></button></a>";
                      }

                      elseif($a['status'] == 'Dikembalikan')
                      {
                        echo "<a href='11_edit_validasi_logbook.php?id_logbook=$a[id_logbook]&pegawai=$a[nip]&bulan=$_GET[bulan]&tahun=$_GET[tahun]'>
                              <button type='button' class='btn btn-warning btn-circle'><i class='glyphicon glyphicon-envelope'></i></button>
                              </a>
                        ";
                      }
