...
{
	$query = mysql_query("SELECT * FROM tb_pengaturan_skp WHERE month(tanggal_pengaturan_skp) = '$_POST[bulan]' AND year(tanggal_pengaturan_skp) = '$_POST[tahun]' AND nip_pegawai='$_POST[pegawai]'");
	$dapat = mysql_fetch_array($query);
?>
<form method="post" action="12_proses_update_atur_skp.php" enctype="multipart/form-data">    
          	<table class= "table table-bordered">    
            	<tr>
					<td colspan="3"><h2>Status Pengaturan SKP Pegawai</h2>
				</tr>
				<tr>
					<td><b>Bulan : </b></td>
					<td> : </td>
