...
<div id="page-wrapper">
    <div class="container-fluid" style="margin:30px;">
		<form method="post" action="11_prosesedit_target_skp_pegawai.php" enctype="multipart/form-data">	
		<table width="100%" class="table table-bordered">
			...
			<input type="hidden" name="bln" value="<?php echo $_GET['bulan']; ?>">
        	...
        	<tr>
				...
				<td width="2%">:</td>
				<td><input type="number" name="jumlah_kegiatan" value="<?php echo "$a[target_kegiatan]"; ?>" required="yes" class="form-control"></td>
        	...
        	<tr>
        		<td><b>Mutu</b></td>
        		<td width="2%">:</td>
				<td colspan="4"><input type="number" name="mutu" value="<?php echo "$a[mutu]"; ?>" class="form-control" ></td>
        	</tr>
