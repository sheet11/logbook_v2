				   ...
				   if(isset($_POST['submit']))
				   {
					   ...
					   echo "<table border='0' width='100%'>   
                      	<tr>
	                        ...
	                        <td>:</td>
	                        <td>$a[bulan]</td>
							<td><a href='03_cetak_target.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Cetak Target SKP Bulanan' class='btn btn-success'></a></td>
							<td><a href='03_cetak_realisasi.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Cetak Realisasi SKP Bulanan' class='btn btn-success'></a></td>
                      	</tr>   
				...
				$i++;
...

				   {
                      ...
                      <tr>
						  ...
						  <td><a href='03_cetak_target.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_GET[bulan]&tahun=$_GET[tahun]' target='_blank'><input type=button value='Cetak Target SKP Bulanan' class='btn btn-success'></a></td>

						  <td><a href='03_cetak_realisasi.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_GET[bulan]&tahun=$_GET[tahun]' target='_blank'><input type=button value='Cetak Realisasi SKP Bulanan' class='btn btn-success'></a></td>
