    ...
    <div class="container-fluid" style="margin:30px;">
		<form method="post" action="" enctype="multipart/form-data">	
			<table width="100%" class="table table-bordered">
	        	...
	        	<tr>
	        		<td><b>Target Waktu / perbulan</b></td>
	        		<td width="2%">:</td>
		...
		<?php
			include"../config/koneksi.php";
				if(isset($_POST['submit']))
					{							
						$query=mysql_query("insert into tb_detail_skp_dosen(uraian_skp, alokasi_waktu, target_waktu, id_daftar_skp)
										values('$_POST[uraian_pekerjaan]','$_POST[alokasi_waktu]','$_POST[target_waktu]','$_POST[skp]')");
						if($query)
							{
								echo"<script>alert('Data Berhasil di Simpan');window.location='13_skp_bulanan.php?bulan=$_POST[bulan]&tahun=$_POST[tahun]'</script>";
							}
						else
							{
							echo"<script>alert('Data Gagal di Simpan');window.location='13_tambah_detail_skp.php?id_daftar_skp=$_POST[skp]&bulan=$_POST[bulan]&tahun=$_POST[tahun]'</script>";
							}
					}					
		?>
	</body>
