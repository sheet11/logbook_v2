        ...
        <div>
            ...
            ?>
               ...
               <table class="table table-bordered" style="font-size:12;">
                ...
                <br/>
                <?php
                    $query = mysql_query("SELECT * FROM `tb_daftar_skp_dosen` WHERE nip='$_GET[pegawai]' AND month(bulan) = '$_GET[bulan]' AND year(bulan) = '$_GET[tahun]' order by id_daftar_skp asc");
