    ...
    <body>
        ...
        <div>
            ...
            <?php
				...
				$qr2 = mysql_query("SELECT * FROM tb_pegawai WHERE nip='$atasan'");
					   ...
					   echo "<table id='example1' class='table table-bordered table-striped' style='font-size:12;'>
                                ...
                                <thead>
									...
									<tr class='info'>
										...
										<th width='5%' rowspan='2'><center>No.</center></th><th rowspan='2' colspan='2'><center>KEGIATAN TUGAS POKOK JABATAN</center></th><th colspan='3'><center>Target Kegiatan</center></th><th colspan='2'><center>Target Waktu</center></th>
