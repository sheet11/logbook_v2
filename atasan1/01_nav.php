                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href=""><i class="fa fa-desktop fa-2x"></i> Penilaian Log Book<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a  href="11_target_skp_pegawai.php"><i class="fa fa-desktop fa-1x"></i>Target SKP</a>
                                </li>
                            </ul>
                    </li>  
					...
					<li>
                        <a href=""><i class="fa fa-desktop fa-2x"></i> Pengaturan<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a  href="12_atur_skp.php"><i class="fa fa-desktop fa-1x"></i> Pengaturan SKP</a>
                                </li>
                                <li>
                                    <a  href="12_atur_logbook.php"><i class="fa fa-desktop fa-1x"></i> Pengaturan Logbook</a>
                                </li>
                            </ul>
                    </li>   
                    ...
                    <li>
                        <a href=""><i class="fa fa-desktop fa-2x"></i> Referensi<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a  href="08_daftar_help_dan_faq.php"><i class="fa fa-desktop fa-1x"></i> Help & FAQ</a>
                                </li>
                            </ul>
                    </li>
