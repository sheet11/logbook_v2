				   ...
				   if(isset($_POST['submit']))
				   {
					   ...
					   echo "<table class='table table-bordered'>   
	                    ...
	                    <tr>
							...
							<td colspan='2'><a href='#' target='_blank'><input type=button value='Verifikasi Target SKP' class='btn btn-success'></a></td>
				...
				$i++;
...

				   {
                      ...
                      <tr>
						  ...
						  <td><a href='11_cetak_target_skp_pegawai.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_GET[pegawai]&bulan=$_GET[bulan]&tahun=$_GET[tahun]' target='_blank'><input type=button value='Cetak Target SKP Bulanan' class='btn btn-success'></a></td>
						  <td><a href='#' target='_blank'><input type=button value='Verifikasi Target SKP' class='btn btn-success'></a></td>

						  <td><a href='11_cetak_realisasi_skp_pegawai.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_GET[pegawai]&bulan=$_GET[bulan]&tahun=$_GET[tahun]' target='_blank'><input type=button value='Cetak Realisasi SKP Bulanan' class='btn btn-success'></a></td>
