...
<div id="page-wrapper">
    <div class="container-fluid" style="margin:30px;">
		<form method="post" action="02_proses_dikembalikan.php" enctype="multipart/form-data">	
		<table width="100%" class="table table-hover">
			<input type="hidden" name="id_logbook" value="<?php echo "$a[id_logbook]"; ?>">
			<tr>
				<td class="info" colspan="2"><b>Keterangan Dikembalikan</b></td>
			</tr>
			
			<tr>
				<td>Keterangan Dikembalikan</td>	
				<td colspan="4"><textarea name="keterangan_atasan" class="form-control"><?php echo "$a[keterangan_atasan]"; ?></textarea></td>
			</tr>
