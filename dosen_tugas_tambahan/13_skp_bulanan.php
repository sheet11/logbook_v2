	    ...
	    <form method="post" action="" enctype="multipart/form-data">    
	        <table width="100%" class= "table table-bordered" style="width:50%;">    
				   ...
				   if(isset($_POST['submit']))
				   {
					   ...
					   echo "<table border='0' width='100%'>   
                      	<tr>
	                        ...
	                        <td>:</td>
	                        <td>$a[bulan]</td>
							<td><a href='13_tambah_skp.php' target='_blank'><input type=button value='Tambah SKP' class='btn btn-warning'></a> &nbsp;
							<a href='13_cetak_target.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Cetak Target' class='btn btn-danger'></a>
							<a href='13_lihat_realisasi.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Lihat Realisasi' class='btn btn-info'></a>
							<a href='13_cetak_realisasi.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Cetak Realisasi' class='btn btn-success'></a></td>
                      	</tr>   
				...
				<tr>
					...
					<td colspan='2'><a href='13_tambah_detail_skp.php?id_daftar_skp=$qry[id_daftar_skp]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' title='Tambah Detail SKP'>$qry[nama_skp]</a></td>
				...
				<tr>
					...
					<td colspan='2'><a href='13_tambah_detail_skp.php?id_daftar_skp=$qry[id_daftar_skp]&bulan=$_GET[bulan]&tahun=$_GET[tahun]' title='Tambah Detail SKP'>$qry[nama_skp]</a></td>
