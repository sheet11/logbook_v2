	            ...
	            <tr>
				   ...
				   if(isset($_POST['submit']))
				   {
					   ...
					   echo "<table border='0' width='100%'>   
						  ...
						  <a href='03_cetak_target.php?id_daftar_skp=$a[id_daftar_skp]&pegawai=$_SESSION[nip]&bulan=$_POST[bulan]&tahun=$_POST[tahun]' target='_blank'><input type=button value='Cetak Target' class='btn btn-primary'></a>&nbsp;</td>
                      	</tr>   
